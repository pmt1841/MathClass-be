...
class AssignmentControllerTest {
    ...
    void publishAssignment_ValidRequest_ReturnsOk() throws Exception {
        ...
        PublishAssignmentRequest.TargetClass target = new PublishAssignmentRequest.TargetClass("MATH101", java.time.LocalDateTime.now().plusDays(7));
    ...
    // ==========================================
    // Tests for getAllAssignmentsForCurrentUser
    // ==========================================
